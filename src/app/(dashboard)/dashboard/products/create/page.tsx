            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <button
                  ...
                  className="w-full px-4 py-2 border-2 border-purple-300 hover:border-purple-400 rounded-lg text-sm font-medium text-purple-700 hover:bg-purple-50 transition-colors"
                >
