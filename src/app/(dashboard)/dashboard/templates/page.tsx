...
import TemplateSelector from '../store/template/TemplateSelector'

/**
 * UNIFIED TEMPLATE PAGE
 * Redirects to /dashboard/store/template (main template selector)
 * This ensures consistent template selection experience
 */
