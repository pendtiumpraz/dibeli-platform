                  ...
                  <div className="p-6">
                    ...
                    {product.hasConversionPage && product.conversionPageSlug ? (
                      <div className="space-y-2">
                        <Link href={`/${store.slug}/${product.conversionPageSlug}`} className="block w-full bg-gradient-to-r from-orange-600 to-yellow-600 hover:from-orange-700 hover:to-yellow-700 text-white py-3 rounded-xl font-bold shadow-lg text-center">Lihat Detail 🐉</Link>
