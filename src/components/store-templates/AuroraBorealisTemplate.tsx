              ...
              >
                ...
                <div className="relative p-6">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-green-500 via-blue-500 to-purple-600 hover:from-green-600 hover:via-blue-600 hover:to-purple-700 text-white py-4 rounded-xl font-black shadow-2xl shadow-green-500/50 transition-all duration-300 transform hover:scale-105"
                  >
                    Order Now
                  </button>
                </div>
